...
static const char* levelC[3] = {"Wan", "Yi"};
static const char* mountC[4] = {"", "Shi", "Bai", "Qian"};
static const char* numberC[10] = {
    "ling", "yi", "er", "san", "si",
    "wu", "liu", "qi", "ba", "jiu"
};

static void readInChinese(vector<string>& res, int& num) {
    bool isAdd = false;
